...
export declare const assertObservables: <T>(source: Observable<T>, target: Observable<T>, asserter: CompareAsserter<T>) => any;
export declare const compareItems: <T>(item: T, other: T, idx?: number) => void;
export declare const expectObs: <T>(source: Observable<T>) => {
    toMatch: (other: Observable<T>, asserter?: CompareAsserter<T>) => any;
};
